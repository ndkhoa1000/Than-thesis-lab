...
if data_up is not None and data_dn is not None:
    ...
    # Đảo thứ tự dữ liệu khi vẽ (energy -> trục y)
    ...
    # Định dạng trục
    plt.axhline(y=0, color='red', linestyle='--', linewidth=3)  # Chuyển sang đường ngang
    plt.ylim(-1.5, 1.5)  # Giới hạn trục y (energy)
    plt.xlim(0, 60)     # Giới hạn trục x (DOS)
